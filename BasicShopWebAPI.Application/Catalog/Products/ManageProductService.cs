...
using BasicShopWebAPI.Common.Exceptions;
using BasicShopWebAPI.Application.Catalog.Products.Dtos.Manage;
...
namespace BasicShopWebAPI.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public Task<PagedResult<ProductViewModel>> GetAllPaging(Dtos.Public.GetProductPagingRequest request)
        {
